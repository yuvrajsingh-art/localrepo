            ...
            <div className=" max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100 ">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input type="text" placeholder="Enter item Name" className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500" onChange={(e) => setName(e.target.value)} value={name} />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500" onChange={(e) => setFoodType(e.target.value)} value={foodType} >
                            ...
                            <option value="non veg">non vag</option>
